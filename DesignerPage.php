        ...
        <main>
            ...
            <div class="portfolio">
                <table class="tableport">
                    ...
                    <tr>
                        ...
                        <?php
                        $sql = "SELECT dp.projectName, dp.description, dc.category AS designCategory
                        ...
                        while($row= mysqli_fetch_assoc($result)){
                            ...
                            echo '<td><button class="B2"><a href="Update.php">Edit</a></button></td>';
                            echo '<td><button class="B2"><a href="">Delete</a></button></td>';
                            echo '</tr>';
                        }
                        ?>
            ...
            <div class="consultation">
                <table>
                    ...
                    <?php
                        $sql = "SELECT dcr.id, c.firstName AS clientFName,c.lastName AS clientLName, rt.type AS roomType, dcat.category AS designCategory, dcr.roomWidth, dcr.roomLength, dcr.colorPrefrences, dcr.date
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td>' . $row["date"] . '</td>';
                            echo '<td><button class="B2"><a href="consultation.html">Provide Consultation</a></button></td>';
                            echo '<td><button class="B2"> <a href="">Decline Consultation</a> </button></td>';
                            echo '</tr>';
                        }
                        ?>
                </table>
